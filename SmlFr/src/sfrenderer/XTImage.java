...
public class XTImage {
  ...
  /**  Creates a new instance of this class using an existing image */
    ...
    public XTImage(String PathToImageFile){
        this(new java.io.File(PathToImageFile));
    }
    
    public XTImage(java.io.File File){
        createBufferedImage(File);
    }

    public XTImage(java.io.InputStream InputStream){
        createBufferedImage(InputStream);
    }
    
    public XTImage(byte[] byteArray){
    ...
    public XTImage(BufferedImage bufferedImage){
        this.bufferedImage = bufferedImage;
    }


    public XTImage(RenderedImage img) {
   ...
   */
    ...
    public XTImage(String text, Font font, int r, int g, int b){
  ...
  /** Returns a copy of the current image. */
    ...
    public XTImage copy(){
        return new XTImage(bufferedImage);
    }
  ...
  /** Returns a copy of the image at a given rectangle. */
    ...
    public XTImage copyRect(int x, int y, int width, int height){
        return new XTImage(getSubimage(x,y,width,height));
    }
  ...
  /**  Used to retrieve a scaled copy of the current image. */
    ...
    public BufferedImage getBufferedImage(int width, int height, boolean maintainRatio){
        XTImage image = new XTImage(getBufferedImage());
